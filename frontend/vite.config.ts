...
const siteConfiguration = fs.existsSync(siteConfigPath)
  ? JSON.parse(fs.readFileSync(siteConfigPath, 'utf-8').replace(/^\uFEFF/, ''))
  : {
      title: 'Thobeka Zitha — Software & AI Developer',
      description: 'Portfolio of Thobeka Zitha, a full-stack developer and AI/ML enthusiast.',
      language: 'en',
    }
